...
const User1 = () => {
    ...
    const getAllUsers = () => {
        axios.get("http://localhost:3009/User1").then((response) => {
    ...
    const addUser = () => {
        axios.post("http://localhost:3009/User1", persion).then((res) => {
            getAllUsers();
            clearForm()
        })
    }
    const deleteUser = (val) => {
        axios.delete("http://localhost:3009/User1/" + val.id).then((res) => {
            getAllUsers()
        })
    }
    const editUser = (val) => {
    ...
    const updateUser=()=>{
        axios.put("http://localhost:3009/User1/"+persion.id,persion).then((res)=>{
            getAllUsers()
            isEdit(false)
        })
clearForm()
