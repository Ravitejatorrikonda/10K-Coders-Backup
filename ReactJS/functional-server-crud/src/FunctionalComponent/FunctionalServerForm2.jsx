...
const USer2 = () => {
    ...
    const getAllUsers = () => {
        axios.get("http://localhost:3009/User2").then((response) => {
    ...
    const addUser = () => {
        axios.post("http://localhost:3009/User2/", persion).then((res) => {
            getAllUsers()
            clearForm()
        })
    }
    ...
    const delUser=(val)=>{
           axios.delete("http://localhost:3009/User2/"+val.id).then((res)=>{
            getAllUsers()
           })
    }
    const Edituser=(val)=>{
    ...
    const updateUser=()=>{
        axios.put("http://localhost:3009/User2/"+persion.id,persion).then((res)=>{
            getAllUsers()
            setisEdit(false)
            clearForm()
