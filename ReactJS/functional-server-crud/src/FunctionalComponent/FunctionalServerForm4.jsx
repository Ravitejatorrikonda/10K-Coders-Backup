...
const User4=()=>{
    ...
    const getAllUsers=()=>{
        axios.get("http://localhost:3009/User4").then((res)=>{
            setdata(res.data)
        })
    }
    const addUser=()=>{
        axios.post("http://localhost:3009/User4",persions).then((res)=>{
            getAllUsers()
            clearForm()
        })
    }
    ...
    const delUser=(val)=>{
axios.delete("http://localhost:3009/User4/"+val.id).then((res)=>{
    getAllUsers()
})
    }
    const updateUser=()=>{
        axios.put("http://localhost:3009/User4/"+persions.id,persions).then((res)=>{
            getAllUsers()
            setedit(false)
            clearForm()
        })
