...
const User5 = () => {
    ...
    const getAllUsers = () => {
        axios.get("http://localhost:3009/User5").then((res) => {
            setdata(res.data)
        })
    }
    const addUser = () => {
        axios.post("http://localhost:3009/User5/", persion).then((res) => {
            getAllUsers()
            clearForm()
        })
    }
    ...
    const delUser = (val) => {
        axios.delete("http://localhost:3009/User5/" + val.id).then((res) => {
            getAllUsers()
        })
    }
    const updateUser = () => {
        axios.put("http://localhost:3009/User5/" + persion.id, persion).then((res) => {
